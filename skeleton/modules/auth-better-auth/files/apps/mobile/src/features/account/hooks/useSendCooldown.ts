...
/**
 * The wait, counted against the wall clock rather than by ticks: the OS throttles timers
 * while the app is backgrounded, and someone who leaves to fetch the code from their mail
 * must come back to a wait that ran while they were gone, not one paused where they left.
 * The web's hook, line for line.
 */
